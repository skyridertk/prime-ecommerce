...
import blue_rasperry_back from '@/assets/PrimeHydration_Stick_6serve_BlueRaspberry_0002_1800x1800.png';
import blue_rasperry_side from '@/assets/Prime_HydrationStick_combo_BlueRaspberry_0000_1800x1800.png';
import blue_rasperry_front from '@/assets/PrimeHydration_stickpack_BlueRasberry_0000_1800x1800-front.png';
...
export default function BlueRasperryStickPage() {
        ...
        <div className='py-32 flex p-10 justify-center flex-col items-center'>
            <div className='max-w-6xl flex'>
                ...
                <div className='w-5/12 px-10 space-y-4'>
                    <ProductDetail title={'Blue Rasperry'} price="$13.99" description="Pay in 4 interest-free installments for orders over $50.00">
