...
import lemon_limefront from '@/assets/PrimeHydration_1serve_lemonlime_0000_1799x1799-front.png';
import lemon_limeside from '@/assets/PrimeHydration_1serve_lemonlime_0001_1799x1799.png';
import lemon_limeback from '@/assets/PrimeHydration_1serve_lemonlime_0002_1799x1799.png';
...
export default function LemonLimePage() {
        ...
        <div className='py-32 flex p-10 justify-center flex-col items-center'>
            <div className='max-w-6xl flex'>
                ...
                <div className='w-5/12 px-10 space-y-4'>
                    <ProductDetail title={'Lemon Lime'} price="$29.99" description="Pay in 4 interest-free installments for orders over $50.00">
