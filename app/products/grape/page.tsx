...
import grapefront from '@/assets/PrimeHydration_1serve_grape_0000_1799x1799-front.png';
import grapeside from '@/assets/PrimeHydration_1serve_grape_0001_1799x1799.png';
import grapeback from '@/assets/PrimeHydration_1serve_grape_0002_1799x1799.png';
    ...
    return (
        <div className='py-32 flex p-10 justify-center flex-col items-center'>
            <div className='max-w-6xl flex'>
                ...
                <CarouselItem front={grapefront} side={grapeside} back={grapeback} />

                <div className='w-5/12 px-10 space-y-4'>
                    <ProductDetail title={'Grape'} price="$29.99" description="Pay in 4 interest-free installments for orders over $50.00">
