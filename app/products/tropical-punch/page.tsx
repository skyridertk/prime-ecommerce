...
import tropical_punchfront from '@/assets/PrimeHydration_1serve_tropicalpunch_0000_1799x1799-front.png';
import tropical_punchside from '@/assets/PrimeHydration_1serve_tropicalpunch_0001_1799x1799.png';
import tropical_punchback from '@/assets/PrimeHydration_1serve_tropicalpunch_0002_1799x1799.png';
        ...
        <div className='py-32 flex p-10 justify-center flex-col items-center'>
            <div className='max-w-6xl flex'>
                ...
                <div className='w-5/12 px-10 space-y-4'>
                    <ProductDetail title={'Tropical Punch'} price="$29.99" description="Pay in 4 interest-free installments for orders over $50.00">
