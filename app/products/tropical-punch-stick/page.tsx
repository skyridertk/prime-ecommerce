...
import tropical_punchfront from '@/assets/PrimeHydration_stickpack_TropicalPunch_0000_1800x1800-front.png';
import tropical_punchside from '@/assets/Prime_HydrationStick_combo_TropicalPunch_0000_1800x1800.png';
import tropical_punchback from '@/assets/PrimeHydration_Stick_6serve_TropicalPunch_0002_1800x1800.png';
    ...
    return (
        <div className='py-32 flex p-10 justify-center flex-col items-center'>
            <div className='max-w-6xl flex'>
                ...
                <CarouselItem front={tropical_punchfront} side={tropical_punchside} back={tropical_punchback} />

                <div className='w-5/12 px-10 space-y-4'>
                    <ProductDetail title={'Tropical Punch'} price="$13.99" description="Pay in 4 interest-free installments for orders over $50.00">
